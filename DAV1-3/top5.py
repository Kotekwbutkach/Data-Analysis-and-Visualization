...
from lib.animaplot import plot_countries_bar, show_plot, save_gif


def create_plots(data_path: str, output_path: str, show=False, codes=False,
...
if __name__ == '__main__':
    anim_plot = create_plots('data/43dcc335-3110-4fcb-9b9f-94e318719e3c_Data.csv',
                            'output/graphgif_top5.gif', show=True, codes=False, plot_type = "line")
    anim_plot2 = create_plots('data/43dcc335-3110-4fcb-9b9f-94e318719e3c_Data.csv',
                             'output/graphgif_top5_col.gif', show=True, codes=True, color="col")
    anim_plot3 = create_plots('data/43dcc335-3110-4fcb-9b9f-94e318719e3c_Data.csv',
                              'output/graphgif_top5_gs.gif', show=True, codes=True, color="gs")
